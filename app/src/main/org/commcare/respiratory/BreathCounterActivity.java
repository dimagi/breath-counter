...
public class BreathCounterActivity extends Activity implements OnInitListener {
    ...
    class C00045 implements OnClickListener {
        ...
        public void onClick(View arg0) {
            MediaPlayer.create(BreathCounterActivity.this, C0005R.raw.beep).start();
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mBreathButton.setText(getResources().getString(C0005R.string.start_button));
        this.mResetButton1.setText(getResources().getString(C0005R.string.reset_button));
        this.mResetButton2.setText(getResources().getString(C0005R.string.reset_button));
        this.mRecordAnswerButton.setText(getResources().getString(C0005R.string.record_button));
        this.mQuestionButton.setImageResource(17301554);
        ...
        this.mBreathButton.setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {
                ...
                BreathCounterActivity.this.mBreathButton.setText(BreathCounterActivity.this.getResources().getString(C0005R.string.breath_button));
                vibrator.vibrate(75);
    ...
    private void enableBreathButton() {
        ...
        this.mBreathButton.setTextColor(-16777216);
    ...
    private void updateSeconds() {
        if (this.mHandler.running()) {
            ...
            if (this.mSeconds.doubleValue() > 59.9d) {
                this.mHandler.stop();
                MediaPlayer.create(this, C0005R.raw.beep).start();
    ...
    private void setSeconds(double count) {
        ...
        this.mTimeView.setText(new StringBuilder(String.valueOf(getResources().getString(C0005R.string.seconds_label))).append(new DecimalFormat("0.0").format(this.mSeconds)).toString());
    }

    private void setBreaths(int count) {
        this.mBreaths = count;
        this.mBreathCountView.setText(new StringBuilder(String.valueOf(getResources().getString(C0005R.string.breaths_label))).append(this.mBreaths).toString());
    }

    private void setAnswer(int count) {
        if (count == -1) {
            this.mBreathsPerMinView.setText(getResources().getString(C0005R.string.bpm_label));
            this.mAnswer = null;
            enableBreathButton();
            return;
        }
        this.mBreathsPerMinView.setText(new StringBuilder(String.valueOf(getResources().getString(C0005R.string.bpm_label))).append(count).toString());
    ...
    public void speakResult() {
        if (this.playAudio) {
            speakOut(getResources().getString(C0005R.string.speak_result, new Object[]{this.mAnswer.toString()}));
        }
    }
